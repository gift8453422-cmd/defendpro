            ...
            <div className="bg-tactical-surface border border-white/5 p-8 rounded-2xl shadow-2xl relative z-10">
              ...
              */}
              ...
              >
                ...
                <button 
                  type="submit"
                  className="mt-2 bg-tactical-primary text-tactical-bg font-headline font-bold uppercase tracking-widest py-4 rounded-lg flex items-center justify-center gap-2 hover:brightness-110 transition-all"
                >
